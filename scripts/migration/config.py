...
Data: 2026-02-21 (v2 — corrigido parametrização)
"""
...
MYSQL_DUMP_PATH = os.getenv(
    "MYSQL_DUMP_PATH",
    "/home/marciorsm/AlmasaStudio/bkpBancoFormatoAntigo/bkpjpw_20260220_121003.sql"
)
...
POSTGRES_DSN = os.getenv(
    "POSTGRES_DSN",
    "postgresql://neondb_owner:npg_2ZejvShNozy3@ep-fancy-sky-addi2jzs-pooler.c-2.us-east-1.aws.neon.tech/almasaStudio?sslmode=require"
)
