...
class PessoaService
{
    ...
    public function buscarConjugePessoa(int $pessoaId): ?array
    {
        ...
        return [
            ...
            'nacionalidadeNome' => $conjuge->getNacionalidade() ? $conjuge->getNacionalidade()->getNome() : null,
            'naturalidade' => $conjuge->getNaturalidade() ? $conjuge->getNaturalidade()->getId() : null,
            'naturalidadeNome' => $conjuge->getNaturalidade() ? $conjuge->getNaturalidade()->getNome() : null,
