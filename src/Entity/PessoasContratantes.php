...
use App\Repository\PessoaContratanteRepository; // Supondo que o repositório exista ou será criado

#[ORM\Entity(repositoryClass: PessoaContratanteRepository::class)]
